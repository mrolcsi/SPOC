...
public final class TagsFragment extends CategoriesFragment {
    ...
    protected CategoryHeaderLoader setupCategoryLoader() {
        return new CategoryHeaderLoader() {
            ...
            public void loadIcon(ImageView view, String headerText, String extra) {
                view.setImageResource(R.drawable.label_white);
            }
    ...
    protected Loader<Cursor> setupLoader() {
        ...
        mQueryArgs.putStringArray(ImagesTableLoader.ARG_SELECTION_ARGS, new String[]{LabelType.CUSTOM.name()});
        ...
        return getLoaderManager().initLoader(LABELS_LOADER_ID, mQueryArgs, new ImagesTableLoader(getActivity(), this));
    }

    @Override
    public int getLoaderId() {
        return LABELS_LOADER_ID;
    }
}
